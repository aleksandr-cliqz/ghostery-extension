				...
				<div className="columns small-12 medium-9 large-6">
					<div className="row small-up-2 align-center">
						<div className="columns one-click">
							<Link to="/done" tabIndex="0" className="button box-link selectable" onClick={this._oneClickSetup}>
						...
						<div className="columns custom">
							<Link to="/blocking" tabIndex="0" className="button box-link selectable" onClick={this._customSetup}>
